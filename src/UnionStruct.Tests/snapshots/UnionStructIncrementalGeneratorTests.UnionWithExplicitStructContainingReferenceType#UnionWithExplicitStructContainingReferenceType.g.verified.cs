//HintName: UnionWithExplicitStructContainingReferenceType.g.cs
// <auto-generated>
...
internal partial struct UnionWithExplicitStructContainingReferenceType : global::System.IEquatable<UnionWithExplicitStructContainingReferenceType>
{
	...
	public Tests.ExplicitStruct TextData;

	private UnionWithExplicitStructContainingReferenceType(global::System.Int32 caseIndex)
	{
		CaseIndex = caseIndex;
	}
	...
	public static partial UnionWithExplicitStructContainingReferenceType Int(
		int @value
	)
	{
		UnionWithExplicitStructContainingReferenceType ___factoryReturnValue = new(IntIndex);
		___factoryReturnValue.IntData = @value;
		return ___factoryReturnValue;
	}

	public static partial UnionWithExplicitStructContainingReferenceType Text(
		Tests.ExplicitStruct @struct
	)
	{
		UnionWithExplicitStructContainingReferenceType ___factoryReturnValue = new(TextIndex);
		___factoryReturnValue.TextData = @struct;
		return ___factoryReturnValue;
	}

	public void Switch(
		global::System.Action<int> @int,
		global::System.Action<Tests.ExplicitStruct> @text
	)
	{
		switch (CaseIndex)
		{
	...
	public TMatchOut Match<TMatchOut>(
		...
		global::System.Func<Tests.ExplicitStruct, TMatchOut> @text
	)
	{
	...
	public override readonly global::System.String ToString()
	{
		return CaseIndex switch
		{
			...
			TextIndex => $"Text {{ @struct = {TextData} }}",
			_ => throw new global::System.Diagnostics.UnreachableException($"Invalid case index: {CaseIndex}."),
		};
	}
	...
	public static bool operator !=(UnionWithExplicitStructContainingReferenceType left, UnionWithExplicitStructContainingReferenceType right)
	{
		return !(left == right);
	}
	...
	public override readonly global::System.Int32 GetHashCode()
	{
		return CaseIndex switch
		{
			...
			TextIndex => unchecked ( TextIndex * -1521134295 + global::System.Collections.Generic.EqualityComparer<Tests.ExplicitStruct>.Default.GetHashCode(TextData) ),
			_ => 2,
		};
	}
	...
	{
		return obj is UnionWithExplicitStructContainingReferenceType && Equals((UnionWithExplicitStructContainingReferenceType)obj);
	}

	public readonly global::System.Boolean Equals(UnionWithExplicitStructContainingReferenceType other)
	{
		return CaseIndex == other.CaseIndex && CaseIndex switch
		{
			...
			TextIndex => global::System.Collections.Generic.EqualityComparer<Tests.ExplicitStruct>.Default.Equals(TextData, other.TextData),
			_ => true,
		};
	}
